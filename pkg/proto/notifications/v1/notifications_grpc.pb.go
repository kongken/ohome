...
const (
	NotificationService_List_FullMethodName        = "/notifications.v1.NotificationService/List"
	NotificationService_UnreadCount_FullMethodName = "/notifications.v1.NotificationService/UnreadCount"
	NotificationService_MarkRead_FullMethodName    = "/notifications.v1.NotificationService/MarkRead"
	NotificationService_MarkAllRead_FullMethodName = "/notifications.v1.NotificationService/MarkAllRead"
	NotificationService_Delete_FullMethodName      = "/notifications.v1.NotificationService/Delete"
)
...
//
// NotificationService powers the bell icon and mobile "Alerts" tab.
//
// HTTP mapping (see api.md §8):
//
